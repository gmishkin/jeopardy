export default function (scorecards) {
    ...
    for (let i = 0; i < scorecards.length; i++) {
        ...
        if (scorecards[i].min_score === scorecards[i].max_score && scorecards[i].max_score > max_settled_score) {
            max_settled_score = scorecards[i].max_score;
        }
        ...
        else if (scorecards[i].max_score < min_other_mins || scorecards[i].max_score < max_settled_score) {
