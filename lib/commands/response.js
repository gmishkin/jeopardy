import { recordResponse, recordFinalResponse } from '../dao/scorecards';
...
export async function regularResponse(text, channel_id) {
    ...
    return { response_type: "in_channel", text: answer[1] + " (" + points + " points)" };
}
...
export async function finalResponse(text, channel_id) {
    ...
    return { response_type: "in_channel", text: answer[1] };
}
